...
// 1. Trucul pentru a repara eroarea "GPUShaderStage is undefined"
if (
  typeof window !== "undefined" &&
  typeof (window as any).GPUShaderStage === "undefined"
) {
  (window as any).GPUShaderStage = { VERTEX: 1, FRAGMENT: 2, COMPUTE: 4 };
}

// 2. Importăm componenta Globe dinamic (oprindu-i randarea pe server)
