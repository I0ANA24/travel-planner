    ...
    <nav className="bg-white shadow-md py-4 border-b border-gray-200">
      <div className="container mx-auto flex justify-between items-center px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-4 lg:space-x-8">
          <Link href={"/trips"} className="text-slate-900 hover:text-sky-500 font-medium">
            My Tripse
          </Link>
          <Link href={"/globe"} className="text-slate-900 hover:text-sky-500 font-medium">
            Globe
          </Link>

          <button className="flex items-center justify-center bg-gray-800 hover:bg-gray-900 text-white px-4 py-2 rounded-sm cursor-pointer">
            Sign In
            <svg
